//
// Created by RainSure on 24-8-10.
//

#ifndef POISSONRECONCGAL_POISSONRECON_H
#define POISSONRECONCGAL_POISSONRECON_H
...
int solve(const std::string& fileName = R"(D:\Code\Data\Cube.xyz)", const std::string& output = R"(D:\Code\Data\Cube.off)")
{
    // Poisson options
    ...
    PointList points;
    if(!CGAL::IO::read_points(CGAL::data_file_path(fileName), std::back_inserter(points),
...
#endif //POISSONRECONCGAL_POISSONRECON_H
